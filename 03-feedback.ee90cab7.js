...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r={form:document.querySelector(".feedback-form")},a="feedback-form-state";n();const o={email:r.form.email.value,message:r.form.message.value};function s(e){o[e.target.name]=e.target.value,localStorage.setItem(a,JSON.stringify(o))}function l(e){e.preventDefault();const t={email:e.currentTarget.email.value,massage:e.currentTarget.message.value};console.log(t),localStorage.removeItem(a),r.form.reset()}function n(){try{const t=localStorage.getItem(STORAGE_KEY);if(!t)return;o=JSON.parse(t);for(let e in o)form.elements[e].value=o[e]}catch(e){console.log("Get state error: ",e.message)}}r.form.addEventListener("input",(0,e.default)(s,500)),r.form.addEventListener("submit",l);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.ee90cab7.js.map