...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={form:document.querySelector(".feedback-form")},r="feedback-form-state";l();const o={email:a.form.email.value,message:a.form.message.value};function m(e){o[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(o))}function s(e){e.preventDefault();const t={email:e.currentTarget.email.value,massage:e.currentTarget.message.value};console.log(t),localStorage.removeItem(r),a.form.reset()}function l(){const e=JSON.parse(localStorage.getItem(r));e&&(e.email&&(a.form.email.value=e.email),e.message&&(a.form.message.value=e.message))}a.form.addEventListener("input",(0,e.default)(m,500)),a.form.addEventListener("submit",s);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.5f5abf23.js.map